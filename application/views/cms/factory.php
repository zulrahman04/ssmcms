                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:20%">
                                    <button type="button" class="btn btn-warning" onclick="editFactory('<?= $key->id ?>')">
                                        <i class="fa fa-edit fa-sm text-white-50"></i> Edit
                                    </button>
                                    <button type="button" class="btn btn-danger" onclick="deleteFactory(<?= $key->id ?>,'<?= $key->nama ?>')">
...
<!-- Modal Edit -->
<div class="modal fade" id="editFactory" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form method="post" action='<?= base_url('cms/') ?>project/editFactory' enctype="multipart/form-data" accept-charset="utf-8" class="user" id="editFormProject">
                <div class="modal-body">
                    <div class="form-group">
...
<script>
    ...
    function deleteFactory(id, project){
        Swal.fire({
            title: 'Warning',
